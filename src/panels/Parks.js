...
const parkinfo = [
    ...
    {id: '3', name: 'Трамвайный парк № 3 (имени Блохина)', info: 'Открыт в 1876 году как «Петербургский коночный парк»,' +
            ' с 1909 года — «Петербургский трамвайный парк».  На трамвае  20-го или 21-го маршрута В.И. Ленин ехал от 1го Муринского проспекта до Боткинской улицы, когда пробирался с последней конспиративной квартиры в штаб революции — Смольный. Поехал бы он и дальше, через Литейный мост, но было поздно — вагон шёл в парк.' +
