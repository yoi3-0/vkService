...
const routes = [
	...
	{id: 1007, name: "Трамвай 7", cost: '40', park: 'Трамвайный парк №7', sostav:' ЛМ-68М2, ЛВС-86, ЛВС-97, 71-301, 71-623-02, 71-631, 71-631-02',
		finalstop:'проспект Солидарности — Перекупной переулок', metro:'Площадь Александра Невского  || ' + 'Ломоносовская || ' + 'Новочеркасская || ' + 'Улица Дыбенко wfafawfawfawfawfawfawvawfawfa'},
