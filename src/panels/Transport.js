...
const routes = [
	...
	{id: 1010, name: "Трамвай 10", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №7', sostav:'ЛМ-68М3, 71-88, 71-631-02',
		finalstop1:'проспект Солидарности —', finalstop2:'Бокситогорская улица', metro1:'Новочеркасская', metro2:'Проспект Большевиков'},
	{id: 1016, name: "Трамвай 16", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №8', sostav:'ЛМ-68М2, ЛМ-68М3, ЛМ-99, ЛМ-99АВН, ЛМ-2008, ЛВС-86',
	...
	{id: 1018, name: "Трамвай 18", cost: '40', park: 'Трамвайный парк №5', sostav:'ЛВС-86',
		finalstop1:'улица Шаврова — ', finalstop2:'станция метро Старая Деревня', metro1:'Старая деревня'},
	{id: 1019, name: "Трамвай 19", cost: '40', park: 'Трамвайный парк №5', sostav:'ЛМ-99, ЛВС-86',
		finalstop1:'Лахтинский разлив — ', finalstop2:'платформа Старая Деревня', metro1:'Старая деревня', metro2:'Беговая'},
	{id: 1020, name: "Трамвай 20", cost: '40', park: 'Трамвайный парк №3, СТТП', sostav:' ЛМ-68М2, ЛМ-68М3, ЛМ-99, ЛВС-86',
	...
	{id: 1021, name: "Трамвай 21", cost: '40', park: 'Трамвайный парк №3', sostav:'ЛМ-68М2, ЛМ-99АВН, ЛВС-86',
	...
	{id: 1023, name: "Трамвай 23", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №7', sostav:'ЛМ-68М2, ЛМ-99, 71-301, 71-407, 71-623, 71-623-02, ЛВС-86, ЛВС-97',
	...
	{id: 1024, name: "Трамвай 24", cost: '40', park: 'Трамвайный парк №7', sostav:'ЛМ-99, ЛВС-86',
	...
	{id: 1025, name: "Трамвай 25", cost: '40', park: 'Трамвайный парк №1', sostav:'ЛМ-99АВН, ЛМ-2008, ЛВС-2005, ЛВС-86',
	...
	{id: 1027, name: "Трамвай 27", cost: '40', park: 'Трамвайный парк №7', sostav:'ЛМ-99, ЛВС-86, ЛВС-97, 71-631, 71-631-02',
	...
	{id: 1029, name: "Трамвай 29", cost: '40', park: 'Трамвайный парк №1', sostav:'ЛМ-99АВН, ЛМ-2008',
	...
	{id: 1036, name: "Трамвай 36", cost: '40', park: 'Трамвайный парк №8', sostav:'ЛМ-99, ЛВС-86, ЛВС-97',
		finalstop1:'Оборонная улица -', finalstop2:'Стрельна', metro1:'Кировский завод', metro2:'Автово'},
	{id: 1038, name: "Трамвай 38", cost: '40', park: 'Трамвайный парк №3, СТТП', sostav:'ЛМ-99, ЛМ-99АВН, ЛВС-86, ЛВС-97',
	...
	{id: 1039, name: "Трамвай 39", cost: '40', park: 'Трамвайный парк №7', sostav:'71-631-02',
	...
	{id: 1040, name: "Трамвай 40", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №5', sostav:'ЛМ-68М2, ЛМ-99АВН, 71-623-03, ЛВС-86',
	...
	{id: 1041, name: "Трамвай 41", cost: '40', park: 'Трамвайный парк №8', sostav:'ЛМ-99, ЛВС-86, ЛВС-97',
		finalstop1:'завод "Северная Верфь" -', finalstop2:'площадь Тургенева', metro1:'Кировский завод'},
	{id: 1043, name: "Трамвай 43", cost: '40', park: 'Трамвайный парк №1', sostav:'ЛМ-99АВН, ЛМ-2008',
	...
	{id: 1045, name: "Трамвай 45", cost: '40', park: 'Трамвайный парк №1', sostav:'ЛМ-99АВН, ЛМ-2008',
	...
	{id: 1047, name: "Трамвай 47", cost: '40', park: 'Трамвайный парк №5', sostav:'ЛВС-86, ЛВС-97',
		finalstop1:'улица Шаврова —', finalstop2:'Удельный парк', metro1:'Пионерская', metro2:'Комендантский проспект'},
	{id: 1048, name: "Трамвай 48", cost: '40', park: 'Трамвайный парк №5', sostav:'ЛМ-99, ЛВС-86, БКМ-843',
		finalstop1:'Лахтинский разлив —', finalstop2:'станция Кушелевка', metro1:'Чёрная речка', metro2:'Беговая'},
	{id: 1049, name: "Трамвай 49", cost: '40', park: 'Трамвайный парк №1', sostav:'ЛМ-99АВН, ЛМ-2008, ЛВС-86, ЛВС-97, ЛВС-2005',
	...
	{id: 1051, name: "Трамвай 51", cost: '40', park: 'СТТП', sostav:'ЛМ-99',
		finalstop1:'Суздальский проспект —', finalstop2:'станция Пискарёвка', metro1:'Гражданский проспект'},
	{id: 1052, name: "Трамвай 52", cost: '40', park: 'Трамвайный парк №8', sostav:'ЛВС-86, ЛВС-97',
		finalstop1:'завод "Северная Верфь" —', finalstop2:'станция Сосновая Поляна', metro1:'Автово'},
	{id: 1055, name: "Трамвай 55", cost: '40', park: 'Трамвайный парк №5', sostav:'ЛВС-86, ЛВС-97, 71-631, 71-631-02',
	...
	{id: 1057, name: "Трамвай 57", cost: '40', park: 'СТТП', sostav:'ЛМ-99',
		finalstop1:'Тихорецкий проспект — ', finalstop2:'проспект Луначарского', metro1:'Академическая'},
	{id: 1058, name: "Трамвай 58", cost: '40', park: 'СТТП', sostav:'ЛМ-99, ЛМ-99АВН, ЛВС-86, ЛВС-97',
		finalstop1:'проспект Культуры —', finalstop2:'улица Жени Егоровой', metro1:'Озерки', metro2:'Проспект Просвещения'},
	{id: 1059, name: "Трамвай 59", cost: '40', park: 'Трамвайное депо ООО"ТТК"', sostav:' Stadler B85600M',
		finalstop1:'Ладожский вокзал —', finalstop2:'улица Электропультовцев', metro1:'Ладожская'},
	{id: 1060, name: "Трамвай 60", cost: '40', park: 'Трамвайный парк №8', sostav:'ЛВС-86, Alstom Citadis 301 CIS, 71-931М',
		finalstop1:'завод "Северная Верфь" — ', finalstop2:'ЛЭМЗ', metro1:'Автово'},
	{id: 1061, name: "Трамвай 61", cost: '40', park: 'Трамвайный парк №5, CТТП', sostav:'ЛМ-99, ЛМ-99АВН, ЛВС-86',
	...
	{id: 1062, name: "Трамвай 62", cost: '40', park: 'Трамвайный парк №1', sostav:'ЛМ-99АВН, ЛМ-2008, ЛВС-86, ЛВС-97, ЛВС-2005',
		finalstop1:'станция метро Купчино — ', finalstop2:'Малая Балканская улица', metro1:'Купчино', metro2:'Дунайская'},
	{id: 1063, name: "Трамвай 63", cost: '40', park: 'Трамвайное депо ООО"ТТК"', sostav:' Stadler B85600M',
		finalstop1:'Ладожский вокзал —', finalstop2:'улица Передовиков', metro1:'Ладожская'},
	{id: 1064, name: "Трамвай 64", cost: '40', park: 'Трамвайное депо ООО"ТТК"', sostav:' Stadler B85600M',
		finalstop1:'Ладожский вокзал —', finalstop2:'Ладожский вокзал', metro1:'Ладожская'},
	{id: 1100, name: "Трамвай 100", cost: '40', park: 'СТТП', sostav:'ЛМ-99АВН, ЛВС-86, 71-923 "Богатырь", 71-931, 71-931М',
