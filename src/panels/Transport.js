...
const routes = [
	{id: 998, name: "Трамвай Т1", cost: '100', park: 'Трамвайный парк №3', sostav1:'ЛМ-33 (реплика)', col1:'red', col2:'red', schedule: 'От музея ГЭТ в 10:00, 13:00, 16:00, 19:00',
	...
	{id: 1003, name: "Трамвай 3", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №7',
		sostav1:'ЛМ-68М2, ЛМ-68М3, ЛМ-99АВН, 71-301', sostav2:'71-623, 71-623-02, 71-631, 71-631-02', col1:'yellow', col2:'blue',
	...
	{id: 1006, name: "Трамвай 6", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №3 (площадка №2)',
		sostav1:' ЛМ-68М3, ЛМ-99АВН, ЛВС-86, 71-623-03', col1:'blue', col2:'blue',
	...
	{id: 1007, name: "Трамвай 7", cost: '40', park: 'Трамвайный парк №7',
		sostav1:' ЛМ-68М2, ЛВС-86, ЛВС-97, 71-301', sostav2:'71-623-02, 71-631, 71-631-02', col1:'green', col2:'green',
	...
	{id: 1008, name: "Трамвай 8", cost: '40', park: 'Трамвайное депо ООО "ТТК"', sostav1:' Stadler B85600M', col1:'green', col2:'yellow',
		finalstop1:'Хасанская улица —', finalstop2:'Ладожский вокзал', metro1:'Ладожская'},
	{id: 1009, name: "Трамвай 9", cost: '40', park: 'Трамвайный парк №5', sostav1:' ЛМ-99, ЛВС-86, ЛВС-97', col1:'white', col2:'white',
		finalstop1:'станция Пискарёвка — ', finalstop2:'станция метро Удельная', metro1:'Академическая', metro2:'Озерки', metro3:'Удельная'},
	{id: 1010, name: "Трамвай 10", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №7',
		sostav1:'ЛМ-68М3, 71-88, 71-631-02', col1:'green', col2:'blue',
		finalstop1:'проспект Солидарности —', finalstop2:'Бокситогорская улица', metro1:'Новочеркасская', metro2:'Проспект Большевиков'},
	{id: 1016, name: "Трамвай 16", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №8',
	...
	{id: 1018, name: "Трамвай 18", cost: '40', park: 'Трамвайный парк №5', sostav1:'ЛВС-86',  col1:'white', col2:'blue',
		finalstop1:'улица Шаврова — ', finalstop2:'станция метро Старая Деревня', metro1:'Старая деревня'},
	{id: 1019, name: "Трамвай 19", cost: '40', park: 'Трамвайный парк №5', sostav1:'ЛМ-99, ЛВС-86',  col1:'blue', col2:'white',
	...
	{id: 1021, name: "Трамвай 21", cost: '40', park: 'Трамвайный парк №3', sostav1:'ЛМ-68М2, ЛМ-99АВН, ЛВС-86',  col1:'yellow', col2:'white',
	...
	{id: 1023, name: "Трамвай 23", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №7',
	...
	{id: 1024, name: "Трамвай 24", cost: '40', park: 'Трамвайный парк №7', sostav1:'ЛМ-99, ЛВС-86',  col1:'blue', col2:'yellow',
	...
	{id: 1025, name: "Трамвай 25", cost: '40', park: 'Трамвайный парк №1',
	...
	{id: 1027, name: "Трамвай 27", cost: '40', park: 'Трамвайный парк №7',
	...
	{id: 1029, name: "Трамвай 29", cost: '40', park: 'Трамвайный парк №1', sostav1:'ЛМ-99АВН, ЛМ-2008',  col1:'blue', col2:'blue',
	...
	{id: 1036, name: "Трамвай 36", cost: '40', park: 'Трамвайный парк №8', sostav1:'ЛМ-99, ЛВС-86, ЛВС-97',  col1:'red', col2:'red',
	...
	{id: 1039, name: "Трамвай 39", cost: '40', park: 'Трамвайный парк №7', sostav1:'71-631-02',  col1:'red', col2:'red',
	...
	{id: 1040, name: "Трамвай 40", cost: '40', park: 'Трамвайный парк №3, Трамвайный парк №5',
		sostav1:'ЛМ-68М2, ЛМ-99АВН, 71-623-03, ЛВС-86',  col1:'green', col2:'green',
	...
	{id: 1041, name: "Трамвай 41", cost: '40', park: 'Трамвайный парк №8', sostav1:'ЛМ-99, ЛВС-86, ЛВС-97',  col1:'green', col2:'green',
		finalstop1:'завод "Северная Верфь" -', finalstop2:'площадь Тургенева', metro1:'Кировский завод'},
	{id: 1043, name: "Трамвай 43", cost: '40', park: 'Трамвайный парк №1', sostav1:'ЛМ-99АВН, ЛМ-2008',  col1:'white', col2:'white',
	...
	{id: 1045, name: "Трамвай 45", cost: '40', park: 'Трамвайный парк №1', sostav1:'ЛМ-99АВН, ЛМ-2008',  col1:'red', col2:'red',
	...
	{id: 1047, name: "Трамвай 47", cost: '40', park: 'Трамвайный парк №5', sostav1:'ЛВС-86, ЛВС-97', col1:'red', col2:'red',
		finalstop1:'улица Шаврова —', finalstop2:'Удельный парк', metro1:'Пионерская', metro2:'Комендантский проспект'},
	{id: 1048, name: "Трамвай 48", cost: '40', park: 'Трамвайный парк №5', sostav1:'ЛМ-99, ЛВС-86, БКМ-843', col1:'blue', col2:'blue',
		finalstop1:'Лахтинский разлив —', finalstop2:'станция Кушелевка', metro1:'Чёрная речка', metro2:'Беговая'},
	{id: 1049, name: "Трамвай 49", cost: '40', park: 'Трамвайный парк №1',
	...
	{id: 1051, name: "Трамвай 51", cost: '40', park: 'СТТП', sostav1:'ЛМ-99', col1:'red', col2:'yellow',
		finalstop1:'Суздальский проспект —', finalstop2:'станция Пискарёвка', metro1:'Гражданский проспект'},
	{id: 1052, name: "Трамвай 52", cost: '40', park: 'Трамвайный парк №8', sostav1:'ЛВС-86, ЛВС-97', col1:'green', col2:'red',
		finalstop1:'завод "Северная Верфь" —', finalstop2:'станция Сосновая Поляна', metro1:'Автово'},
	{id: 1055, name: "Трамвай 55", cost: '40', park: 'Трамвайный парк №5',
	...
	{id: 1057, name: "Трамвай 57", cost: '40', park: 'СТТП', sostav1:'ЛМ-99', col1:'blue', col2:'white',
		finalstop1:'Тихорецкий проспект — ', finalstop2:'проспект Луначарского', metro1:'Академическая'},
	{id: 1058, name: "Трамвай 58", cost: '40', park: 'СТТП', sostav1:'ЛМ-99, ЛМ-99АВН, ЛВС-86, ЛВС-97', col1:'blue', col2:'red',
		finalstop1:'проспект Культуры —', finalstop2:'улица Жени Егоровой', metro1:'Озерки', metro2:'Проспект Просвещения'},
	{id: 1059, name: "Трамвай 59", cost: '40', park: 'Трамвайное депо ООО"ТТК"', sostav1:' Stadler B85600M', col1:'yellow', col2:'white',
		finalstop1:'Ладожский вокзал —', finalstop2:'улица Электропультовцев', metro1:'Ладожская'},
	{id: 1060, name: "Трамвай 60", cost: '40', park: 'Трамвайный парк №8',
	...
	{id: 1062, name: "Трамвай 62", cost: '40', park: 'Трамвайный парк №1',
	...
	{id: 1063, name: "Трамвай 63", cost: '40', park: 'Трамвайное депо ООО"ТТК"', sostav1:' Stadler B85600M', col1:'blue', col2:'red',
		finalstop1:'Ладожский вокзал —', finalstop2:'улица Передовиков', metro1:'Ладожская'},
	{id: 1064, name: "Трамвай 64", cost: '40', park: 'Трамвайное депо ООО"ТТК"', sostav1:' Stadler B85600M', col1:'red', col2:'yellow',
		finalstop1:'Ладожский вокзал —', finalstop2:'Ладожский вокзал', metro1:'Ладожская'},
	{id: 1065, name: "Трамвай 65", cost: '40', park: 'Трамвайный парк №7', sostav1:'ЛМ-99, ЛВС-86', col1:'green', col2:'white', working_days: '',
