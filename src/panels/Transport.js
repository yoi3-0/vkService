...
const routes = [
	...
	{id: 999, name: "Трамвай А", cost: '50', park: 'Трамвайный парк №7', sostav1:'ЛВС-86, 71-623', col1:'yellow', col2:'yellow', working_days: '',
	...
	{id: 1003, name: "Трамвай 3", cost: '50', park: 'Трамвайные парк №3, №7',
	...
	{id: 1006, name: "Трамвай 6", cost: '50', park: 'Трамвайный парк №3',
	...
	{id: 1007, name: "Трамвай 7", cost: '50', park: 'Трамвайный парк №7',
	...
	{id: 1008, name: "Трамвай 8", cost: '50', park: 'Трамвайное депо ООО "ТТК"', sostav1:' Stadler B85600M', col1:'green', col2:'yellow', lchange:'Вновь открыт в 2018 г.',
		finalstop1:'Хасанская улица —', finalstop2:'Ладожский вокзал', metro1:'Ладожская'},
	{id: 1009, name: "Трамвай 9", cost: '50', park: 'Трамвайный парк №5', sostav1:' ЛМ-99, ЛВС-86, ЛВС-97', col1:'white', col2:'white', lchange:'Изменён в 2013 г.',
		finalstop1:'станция Пискарёвка — ', finalstop2:'станция метро Удельная', metro1:'Академическая', metro2:'Озерки', metro3:'Удельная'},
	{id: 1010, name: "Трамвай 10", cost: '50', park: 'Трамвайные парки №3, №7',
	...
	{id: 1016, name: "Трамвай 16", cost: '50', park: 'Трамвайные парки №1, №3, №8', lchange:'Продлён в 2013 г.',
	...
	{id: 1018, name: "Трамвай 18", cost: '50', park: 'Трамвайный парк №5', sostav1:'ЛВС-86',  col1:'white', col2:'blue', lchange:'Изменён в 2018 г.',
		finalstop1:'улица Шаврова — ', finalstop2:'станция метро Старая Деревня', metro1:'Старая деревня'},
	{id: 1019, name: "Трамвай 19", cost: '50', park: 'Трамвайный парк №5', sostav1:'ЛМ-99, ЛВС-86',  col1:'blue', col2:'white', lchange:'Вновь открыт в 2000 г.',
		finalstop1:'Лахтинский разлив — ', finalstop2:'платформа Старая Деревня', metro1:'Старая деревня', metro2:'Беговая'},
	{id: 1020, name: "Трамвай 20", cost: '50', park: 'Трамвайный парк №3, СТТП', sostav1:' ЛМ-68М2, ЛМ-68М3, ЛМ-99, ЛВС-86',  col1:'green', col2:'white',
	...
	{id: 1021, name: "Трамвай 21", cost: '50', park: 'Трамвайный парк №3', sostav1:'ЛМ-68М2, ЛМ-99АВН, ЛВС-86',  col1:'yellow', col2:'white', lchange:'Изменён в 2006 г.',
	...
	{id: 1023, name: "Трамвай 23", cost: '50', park: 'Трамвайные парки №3, №7', lchange:'Изменён в 2000 г.',
	...
	{id: 1024, name: "Трамвай 24", cost: '50', park: 'Трамвайный парк №7', sostav1:'ЛМ-99, ЛВС-86',  col1:'blue', col2:'yellow', lchange:'Продлён в 2017 г.',
	...
	{id: 1025, name: "Трамвай 25", cost: '50', park: 'Трамвайный парк №1', lchange:'Урезан в 2007 г.',
	...
	{id: 1027, name: "Трамвай 27", cost: '50', park: 'Трамвайный парк №7', lchange:'Изменён в 1993 г.',
	...
	{id: 1029, name: "Трамвай 29", cost: '50', park: 'Трамвайный парк №1', sostav1:'ЛМ-99АВН, ЛМ-2008',  col1:'blue', col2:'blue', lchange:'Урезан в 2006 г.',
	...
	{id: 1036, name: "Трамвай 36", cost: '50', park: 'Трамвайный парк №8', sostav1:'ЛМ-99, ЛВС-86, ЛВС-97',  col1:'red', col2:'red', lchange:'Изменён в 2006 г.',
		finalstop1:'Оборонная улица -', finalstop2:'Стрельна', metro1:'Кировский завод', metro2:'Автово'},
	{id: 1038, name: "Трамвай 38", cost: '50', park: 'Трамвайный парк №3, СТТП', sostav1:'ЛМ-99, ЛМ-99АВН, ЛВС-86, ЛВС-97',  col1:'blue', col2:'yellow',
	...
	{id: 1039, name: "Трамвай 39", cost: '50', park: 'Трамвайный парк №7', sostav1:'71-631-02',  col1:'red', col2:'red', lchange:'Продлён в 2006 г.',
	...
	{id: 1040, name: "Трамвай 40", cost: '50', park: 'Трамвайные парк №3, №5',
	...
	{id: 1041, name: "Трамвай 41", cost: '50', park: 'Трамвайный парк №8', sostav1:'ЛМ-99, ЛВС-86, ЛВС-97',  col1:'green', col2:'green', lchange:'Урезан в 2019 г.',
		finalstop1:'завод "Северная Верфь" -', finalstop2:'площадь Тургенева', metro1:'Кировский завод'},
	{id: 1043, name: "Трамвай 43", cost: '50', park: 'Трамвайный парк №1', sostav1:'ЛМ-99АВН, ЛМ-2008',  col1:'white', col2:'white', lchange:'Урезан в 2006 г.',
	...
	{id: 1045, name: "Трамвай 45", cost: '50', park: 'Трамвайный парк №1', sostav1:'ЛМ-99АВН, ЛМ-2008',  col1:'red', col2:'red', lchange:'Продлён в 1986 г.',
	...
	{id: 1047, name: "Трамвай 47", cost: '50', park: 'Трамвайный парк №5', sostav1:'ЛВС-86, ЛВС-97', col1:'red', col2:'red', lchange:'Вновь открыт в 2018 г.',
		finalstop1:'улица Шаврова —', finalstop2:'Удельный парк', metro1:'Пионерская', metro2:'Комендантский проспект'},
	{id: 1048, name: "Трамвай 48", cost: '50', park: 'Трамвайный парк №5', sostav1:'ЛМ-99, ЛВС-86, БКМ-843', col1:'blue', col2:'blue', lchange:'Вновь открыт в 1993 г.',
		finalstop1:'Лахтинский разлив —', finalstop2:'станция Кушелевка', metro1:'Чёрная речка', metro2:'Беговая'},
	{id: 1049, name: "Трамвай 49", cost: '50', park: 'Трамвайный парк №1', lchange:'Урезан в 1992 г.',
	...
	{id: 1051, name: "Трамвай 51", cost: '50', park: 'СТТП', sostav1:'ЛМ-99', col1:'red', col2:'yellow', lchange:'Урезан 2006 г.',
		finalstop1:'Суздальский проспект —', finalstop2:'станция Пискарёвка', metro1:'Гражданский проспект'},
	{id: 1052, name: "Трамвай 52", cost: '50', park: 'Трамвайный парк №8', sostav1:'ЛВС-86, ЛВС-97', col1:'green', col2:'red', lchange:'Изменён в 1992 г.',
		finalstop1:'завод "Северная Верфь" —', finalstop2:'станция Сосновая Поляна', metro1:'Автово'},
	{id: 1055, name: "Трамвай 55", cost: '50', park: 'Трамвайный парк №5', lchange:'Пролён в 2018 г.',
	...
	{id: 1056, name: "Трамвай 56", cost: '50', park: 'Трамвайный парк №8', sostav1:'ЛВС-86, ЛВС-97', col1:'yellow', col2:'green', working_days: '',
		lchange:'Урезан в 2003 г.',
		finalstop1:'завод "Северная Верфь" —', finalstop2:'улица Маршала Казакова, 22', metro1:'Автово'},
	{id: 1057, name: "Трамвай 57", cost: '50', park: 'СТТП', sostav1:'ЛМ-99', col1:'blue', col2:'white', lchange:'Вновь открыт в 2009 г.',
		finalstop1:'Тихорецкий проспект — ', finalstop2:'проспект Луначарского', metro1:'Академическая'},
	{id: 1058, name: "Трамвай 58", cost: '50', park: 'СТТП', sostav1:'ЛМ-99, ЛМ-99АВН, ЛВС-86, ЛВС-97', col1:'blue', col2:'red', lchange:'Продлён в 2005 г.',
		finalstop1:'проспект Культуры —', finalstop2:'улица Жени Егоровой', metro1:'Озерки', metro2:'Проспект Просвещения'},
	{id: 1059, name: "Трамвай 59", cost: '50', park: 'Трамвайное депо ООО "ТТК"', sostav1:' Stadler B85600M', col1:'yellow', col2:'white', lchange:'Вновь открыт в 2019 г.',
		finalstop1:'Ладожский вокзал —', finalstop2:'улица Электропультовцев', metro1:'Ладожская'},
	{id: 1060, name: "Трамвай 60", cost: '50', park: 'Трамвайный парк №8', lchange:'Продлён в 2019 г.',
	...
	{id: 1061, name: "Трамвай 61", cost: '50', park: 'Трамвайный парк №5, CТТП', sostav1:'ЛМ-99, ЛМ-99АВН, ЛВС-86', col1:'yellow', col2:'yellow',
	...
	{id: 1062, name: "Трамвай 62", cost: '50', park: 'Трамвайный парк №1', lchange:'Изменён в 1986 г.',
	...
	{id: 1063, name: "Трамвай 63", cost: '50', park: 'Трамвайное депо ООО "ТТК"', sostav1:' Stadler B85600M', col1:'blue', col2:'red', lchange:'Вновь открыт в 2019 г.',
		finalstop1:'Ладожский вокзал —', finalstop2:'улица Передовиков', metro1:'Ладожская'},
	{id: 1064, name: "Трамвай 64", cost: '50', park: 'Трамвайное депо ООО "ТТК"', sostav1:' Stadler B85600M', col1:'red', col2:'yellow', lchange:'Вновь открыт в 2019 г.',
		finalstop1:'Ладожский вокзал —', finalstop2:'станция Ржевка', metro1:'Ладожская'},
	{id: 1065, name: "Трамвай 65", cost: '50', park: 'Трамвайный парк №7', sostav1:'ЛМ-99, ЛВС-86', col1:'green', col2:'white', working_days: '', lchange:'Изменён в 2017 г.',
	...
	{id: 1100, name: "Трамвай 100", cost: '50', park: 'СТТП', sostav1:'ЛМ-99АВН, ЛВС-86, 71-923, 71-931', sostav2:'71-931М', col1:'white', col2:'yellow',
...
class Transport extends React.Component {
    ...
    routepic()
    {
    	...
    	console.log('map of route'+this.props.activeRoute-1000);
    	switch (this.props.activeRoute-1000) {
			case -2: this.props.newIframe(<iframe
					id='-2'
					title='-2'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.props.closepopout()}
			...
			case -1: this.props.newIframe(<iframe
					id='-1'
					title='-1'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.props.closepopout()}
			...
			case 3: this.props.newIframe( <iframe
					id='3'
					title='3'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
			...
			case 6: this.props.newIframe(<iframe
					id='6'
					title='6'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 7: this.props.newIframe(<iframe
					id='7'
					title='7'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 8: this.props.newIframe( <iframe
					if='8'
					title='8'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 9: this.props.newIframe(<iframe
					id='9'
					title='9'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 10: this.props.newIframe(<iframe
					id='10'
					title='10'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 16: this.props.newIframe(<iframe
					if='16'
					title='16'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 18: this.props.newIframe( <iframe
					if='18'
					title='18'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 19: this.props.newIframe(<iframe
					id='19'
					title='19'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 20: this.props.newIframe(<iframe
					id='20'
					title='20'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 21: this.props.newIframe(<iframe
					id='21'
					title='21'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 23: this.props.newIframe(<iframe
					id='23'
					title='23'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 24: this.props.newIframe( <iframe
					if='24'
					title='24'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 25: this.props.newIframe( <iframe
					id='25'
					title='25'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 27: this.props.newIframe( <iframe
					if='27'
					title='27'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 29: this.props.newIframe( <iframe
					id='29'
					title='29'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 36: this.props.newIframe(<iframe
					if='36'
					title='36'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 38: this.props.newIframe(<iframe
					id='38'
					title='38'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 39: this.props.newIframe(<iframe
					if='39'
					title='39'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 40: this.props.newIframe(<iframe
					id='40'
					title='40'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 41: this.props.newIframe(<iframe
					id='41'
					title='41'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 43: this.props.newIframe(<iframe
					if='43'
					title='43'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 45: this.props.newIframe( <iframe
					id='45'
					title='45'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 47: this.props.newIframe( <iframe
					if='47'
					title='47'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 48: this.props.newIframe(<iframe
					id='49'
					title='49'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 49: this.props.newIframe(<iframe
					id='49'
					title='49'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 51: this.props.newIframe( <iframe
					id='51'
					title='51'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 52: this.props.newIframe( <iframe
					id='52'
					title='52'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 55: this.props.newIframe( <iframe
					id='55'
					title='55'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 56: this.props.newIframe(<iframe
					id='56'
					title='56'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 57: this.props.newIframe( <iframe
					id='57'
					title='57'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 58: this.props.newIframe(<iframe
					id='58'
					title='58'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 59:this.props.newIframe( <iframe
					id='59'
					title='59'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 60: this.props.newIframe(<iframe
					id='60'
					title='60'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 61: this.props.newIframe( <iframe
					id='61'
					title='61'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 62: this.props.newIframe( <iframe
					id='62'
					title='62'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 63: this.props.newIframe( <iframe
					id='63'
					title='63'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 64: this.props.newIframe(<iframe
					id='64'
					title='64'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 65: this.props.newIframe(<iframe
					id='65'
					title='65'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			case 100: this.props.newIframe(<iframe
					id='100'
					title='100'
					className={osName===IOS? 'MapsCssIOS': 'MapsCssAndroid'}
					onLoad={this.HideSpinner}
			...
			default:
				this.props.newIframe(<Placeholder> Карта маршрута не найдена! Пожалуйста, сообщите, если Вы заметили это сообщение. </Placeholder>);
			break;
		}
		...
		return (
			<View id={this.props.id} activePanel={this.props.activePanel} modal={modal} popout={this.props.popout}
				...
				<Panel id='route_map'>
					...
					>
						Карта маршрута {this.props.activeRoute-1000>-1? this.props.activeRoute-1000 : (this.props.activeRoute-1000===-1? 'A': 'Т1') }
					</PanelHeader>
